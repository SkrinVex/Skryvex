  ...
  Widget build(BuildContext context) {
    ...
    final formContent = Form(
      ...
      child: Column(
        ...
        children: [
          const Text('Создать аккаунт', style: TextStyle(color: AppTheme.textPrimary, fontSize: 22, fontWeight: FontWeight.w600)),
          const SizedBox(height: 4),
          const Text('Введите данные для регистрации', style: TextStyle(color: AppTheme.textSecondary, fontSize: 14)),
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: desktop
            ...
            : SingleChildScrollView(padding: const EdgeInsets.symmetric(horizontal: 28, vertical: 24), child: formContent),
      ),
    );
  }
}
